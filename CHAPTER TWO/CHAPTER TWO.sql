...
-- DriverID Char(35) Not null,
-- DriverName Char(40) not null, 
-- Rating integer(5) Not Null, 
-- TotalRides Char(10) not null 
-- );

-- CREATE TABLE Riders(
-- RiderID Char(35) Not null,
-- RiderName Char(40) not null,
-- City Char(100) not null
-- );

-- CREATE TABLE Rides(

-- RideID Char(35) Not Null,
-- DriverID Char(40) Not Null,
-- RiderID Char(40) Not Null,
-- Fare Numeric(9,2) Not Null,
-- Rating integer(5) Not null,
-- DistanceKM integer(100) Not Null
